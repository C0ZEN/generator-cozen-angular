...
(function () {
	...
	describe('generator-cozen-angular:app', () => {
		...
		it('create app config files', () => {
			assert.file([
				'app/config/providers/alert/alertFloatingProvider.config.js',
				'app/config/providers/alert/alertProvider.config.js',
				'app/config/providers/apiProvider.config.js',
				'app/config/providers/appProvider.config.js',
				'app/config/providers/breadcrumb/breadcrumbAutoProvider.config.js',
				'app/config/providers/breadcrumb/breadcrumbItemProvider.config.js',
				'app/config/providers/breadcrumb/breadcrumbProvider.config.js',
				'app/config/providers/btnProvider.config.js',
				'app/config/providers/cardProvider.config.js',
				'app/config/providers/compileProvider.config.js',
				'app/config/providers/datePicker/datePickerDaysProvider.config.js',
				'app/config/providers/datePicker/datePickerHeaderProvider.config.js',
				'app/config/providers/datePicker/datePickerMonthsProvider.config.js',
				'app/config/providers/datePicker/datePickerProvider.config.js',
				'app/config/providers/datePicker/datePickerWeekProvider.config.js',
				'app/config/providers/datePicker/datePickerYearsProvider.config.js',
				'app/config/providers/debugProvider.config.js',
				'app/config/providers/dropdownProvider.config.js',
				'app/config/providers/dynamicLocaleProvider.config.js',
				'app/config/providers/formProvider.config.js',
				'app/config/providers/httpProvider.config.js',
				'app/config/providers/inputProvider.config.js',
				'app/config/providers/keyboardProvider.config.js',
				'app/config/providers/languageProvider.config.js',
				'app/config/providers/loaderProvider.config.js',
				...
				'app/config/providers/mediaProvider.config.js',
				'app/config/providers/modalProvider.config.js',
				'app/config/providers/momentProvider.config.js',
				'app/config/providers/numberFormatProvider.config.js',
				'app/config/providers/qProvider.config.js',
				'app/config/providers/radioProvider.config.js',
				'app/config/providers/stateProvider.config.js',
				'app/config/providers/svgProvider.config.js',
				'app/config/providers/tabsProvider.config.js',
				'app/config/providers/testProvider.config.js',
				'app/config/providers/textareaProvider.config.js',
				'app/config/providers/themeProvider.config.js',
				'app/config/providers/titleProvider.config.js',
				'app/config/providers/toggleProvider.config.js',
				'app/config/providers/translateProvider.config.js',
				'app/config/providers/workflow/workflowItemProvider.config.js',
				'app/config/providers/workflow/workflowProvider.config.js',
